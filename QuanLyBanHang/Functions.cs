...
namespace QuanLyBanHang.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=admin\thanhnhat;Initial Catalog=QuanLyBanHang;Persist Security Info=True;User ID=sa;Password=thanhnhat1";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        {
            string ma = "";//N'" + txbMaKhach.Text.Trim() +"'
        ...
        public static string ChuyenSoSangChuoi(double so)//public: gọi ra bên ngoài
        {
            if (so == 0)
                return mNumText[0];
            string chuoi = "", hauto = "";
