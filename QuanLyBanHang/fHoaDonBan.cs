    ...
    public partial class fHoaDonBan : Form
    {
        ...
        private void txbSoLuong_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txbSoLuong.Text == "")
                ...
                sl = Convert.ToDouble(txbSoLuong.Text);
            if (txbGiamGia.Text == "")
                gg = 0;
            else
                gg = Convert.ToDouble(txbGiamGia.Text);
            if (txbDonGiaBan.Text == "")
                dg = 0;
            else
                dg = Convert.ToDouble(txbDonGiaBan.Text);
            tt = sl * dg - sl * dg * gg / 100;
            txbThanhTien.Text = tt.ToString();
        }
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien FROM ChiTietHDBan AS a, Hang AS b WHERE a.MaHDBan = N'" + txbMaHDBan.Text + "' AND a.MaHang=b.MaHang";
            ...
            dgvHDBanHang.Columns[5].Width = 170;
        ...
        {
            string str;
            str = "SELECT NgayBan FROM HoaDonBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
            dtpNgayBan.Value = DateTime.Parse(Functions.GetFieldValues(str));
            str = "SELECT MaNhanVien FROM HoaDonBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
            cboMaNhanVien.SelectedValue = Functions.GetFieldValues(str);
            str = "SELECT MaKhach FROM HoaDonBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
            cboMaKhach.SelectedValue = Functions.GetFieldValues(str);
            str = "SELECT TongTien FROM HoaDonBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
            txbTongTien.Text = Functions.GetFieldValues(str);
            lblBangChu.Text = "Bằng chữ: " + Functions.ChuyenSoSangChuoi(Double.Parse(txbTongTien.Text));
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            txbMaHDBan.Text = Functions.CreateKey("HDB");
            LoadDataGridView();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaHDBan FROM HoaDonBan WHERE MaHDBan=N'" + txbMaHDBan.Text + "'";
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO HoaDonBan(MaHDBan, NgayBan, MaNhanVien, MaKhach, TongTien) VALUES (N'" + txbMaHDBan.Text.Trim() + "','" +
                        dtpNgayBan.Value + "',N'" + cboMaNhanVien.SelectedValue + "',N'" +
                        cboMaKhach.SelectedValue + "'," + txbTongTien.Text + ")";
            ...
            if (txbGiamGia.Text.Trim().Length == 0)
            {
            ...
            if (Convert.ToDouble(txbSoLuong.Text) > sl)
            {
            ...
            sql = "INSERT INTO ChiTietHDBan(MaHDBan,MaHang,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txbMaHDBan.Text.Trim() + "',N'" + cboMaHang.SelectedValue + "'," + txbSoLuong.Text + "," + txbDonGiaBan.Text + "," + txbGiamGia.Text + "," + txbThanhTien.Text + ")";
            Functions.RunSql(sql);
            LoadDataGridView();
            // Cập nhật lại số lượng của mặt hàng vào bảng Hang
            SLcon = sl - Convert.ToDouble(txbSoLuong.Text);
            sql = "UPDATE Hang SET SoLuong =" + SLcon + " WHERE MaHang= N'" + cboMaHang.SelectedValue + "'";
            Functions.RunSql(sql);
            // Cập nhật lại tổng tiền cho hóa đơn bán
            tong = Convert.ToDouble(Functions.GetFieldValues("SELECT TongTien FROM HoaDonBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'"));
            Tongmoi = tong + Convert.ToDouble(txbThanhTien.Text);
            sql = "UPDATE HoaDonBan SET TongTien =" + Tongmoi + " WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
            Functions.RunSql(sql);
            txbTongTien.Text = Tongmoi.ToString();
        ...
        private void cboMaHang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txbTenHang.Text = Functions.GetFieldValues(str);
            str = "SELECT DonGiaBan FROM Hang WHERE MaHang =N'" + cboMaHang.SelectedValue + "'";
            txbDonGiaBan.Text = Functions.GetFieldValues(str);
        }
        ...
        private void cboMaKhach_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txbTenKhach.Text = Functions.GetFieldValues(str);
            str = "Select DiaChi from Khach where MaKhach = N'" + cboMaKhach.SelectedValue + "'";
            txbDiaChi.Text = Functions.GetFieldValues(str);
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            txbMaHDBan.Text = cboMaHDBan.Text;
            LoadInfoHoaDon();
            LoadDataGridView();
            btnThem.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            COMExcel.Workbook exBook; //Trong 1 chương trình Excel có nhiều Workbook (tệp của excel)
            ...
            exRange.Range["A1:B1"].Value = "Shop Love Handmade";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Yên Thế, Hồ Chí Minh";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (098)9912345";
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM HoaDonBan AS a, Khach AS b, NhanVien AS c WHERE a.MaHDBan = N'" + txbMaHDBan.Text + "' AND a.MaKhach = b.MaKhach AND a.MaNhanVien = c.MaNhanVien";
            ...
            sql = "SELECT b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia, a.ThanhTien " +
                  ...
                  txbMaHDBan.Text + "' AND a.MaHang = b.MaHang";
        ...
        //tránh trường hợp người sử dụng nhập linh tinh: nhập số thập phân, nhập chữ
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaHang,SoLuong FROM ChiTietHDBan WHERE MaHDBan = N'" + txbMaHDBan.Text + "'";
                ...
                sql = "DELETE ChiTietHDBan WHERE MaHDBan=N'" + txbMaHDBan.Text + "'";
                Functions.RunSql(sql);

                //Xóa hóa đơn
                sql = "DELETE HoaDonBan WHERE MaHDBan=N'" + txbMaHDBan.Text + "'";
                Functions.RunSql(sql);
                ResetValues();
                LoadDataGridView();
                btnXoa.Enabled = false;
        ...
        private void dgvHDBanHang_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                sql = "DELETE ChiTietHDBan WHERE MaHDBan=N'" + txbMaHDBan.Text + "' AND MaHang = N'" + MaHangxoa + "'";
                Functions.RunSql(sql);
                // Cập nhật lại số lượng cho các mặt hàng
        ...
        private void fHoaDonBan_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void cboMaNhanVien_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Khi chọn Mã nhân viên thì các thông tin của nhân viên sẽ hiện ra
            str = "Select TenNhanVien from NhanVien where MaNhanVien = N'" + cboMaNhanVien.SelectedValue + "'";
            txbTenNhanVien.Text = Functions.GetFieldValues(str);
        }

        private void txbGiamGia_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (((e.KeyChar >= '0') && (e.KeyChar <= '9')) || (Convert.ToInt32(e.KeyChar) == 8))
                e.Handled = false;
            else e.Handled = true;
        ...
        private void txbGiamGia_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }
